...
function tabela() {
    ...
    while($aux = mysqli_fetch_assoc($resultado)) { 
        ...
        <td>".$aux['descr']."&nbsp;&nbsp;&nbsp;  </td>
        <td> Iniciado em:".$aux['data_inicial']." </td>
        <td> &nbsp;&nbsp;&nbsp;Investimento inicial:<spam style='color:red;'> R$".$aux['inv_inicial']."</spam></td><td> <form action='exclui.php' method='post'> <input type='hidden' name='escon' id='escon' value='".$aux['id_atividade']."'> <input type='submit' class='btn btn-outline-success' style='margin-left: 10px;' id='botao' value='Exclui'></form></td>
        </tr>";
